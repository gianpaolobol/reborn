...
function mockRecognitionResult() {
  return {
    ...
    object_guess: { label: 'componente da confermare', confidence: 0.34, object_context: 'Modalita demo/fallback: il browser non ha letto davvero la foto. Configura OpenAI Vision live per OCR, marca, modello e codice pezzo.' },
    ...
    recommended_next_step: { path: 'ask_more_photos', reason: 'Modalita demo: per identificare davvero il pezzo serve OpenAI Vision live oppure revisione umana.' },
