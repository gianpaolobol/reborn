...
const REBORN_I18N = {
  it: {
    liveApi: 'API attiva', mockMode: 'Modalit  demo', apiError: 'Errore API', checkingApi: 'Controllo API', noSyncYet: 'Nessuna sincronizzazione', lastSync: 'Ultima sincronizzazione', guest: 'Ospite', savedToken: 'Token salvato', logout: 'Esci', login: 'Accedi', refreshApi: 'Aggiorna API',
    advancedConsole: 'Area operatori', advancedConsoleNote: 'Quest\'area e separata dalla demo pubblica. Il visitatore vede solo il percorso guidato ', backToGuidedRepair: 'Torna al percorso guidato',
    stepProblem: 'Problema', stepPhotos: '', stepGenerate: 'Genera', stepQuote: 'Preventivo',
    ...
    photoPickerMissing: 'Selettore foto non disponibile in questa schermata.', noPhotoSelected: 'Nessuna foto selezionata.', filesSelected: 'file selezionati.', noFilesSelected: 'Nessun file selezionato.', uploadMockUnavailable: 'Il backend non e attivo. Usa il riconoscimento demo.', loginRequiredUpload: 'Devi accedere per caricare le foto del ricambio.', createCaseFirst: 'Crea prima una richiesta di riparazione.', selectAtLeastPhoto: 'Seleziona almeno una foto.', uploadingAndAnalyzing: 'Sto caricando la foto e chiedendo all\'AI di identificare il pezzo...', uploadEvidence: 'Caricamento evidenze di riparazione...', evidenceUploaded: '/evidenze caricate.', uploadRecognitionFailed: 'Caricamento o riconoscimento non riuscito',
    aiAnalyzing: 'L\'AI sta analizzando la foto. La prima richiesta reale puo richiedere fino a 90 secondi.', aiFailed: 'Riconoscimento AI non riuscito', noUploadedPhoto: 'Non e disponibile nessuna foto caricata per il riconoscimento AI.', aiNoClearResult: 'L\'AI non ha restituito un risultato chiaro. La schermata indica cosa provare ora.', aiNeedsMore: 'Serve un\'altra immagine o un riferimento di scala prima di identificare bene il pezzo.', aiIdentified: 'L\'AI ha identificato il ricambio probabile e ha generato un brief chiaro.', toastAiNoIdentify: 'L\'AI non riesce ancora a identificare il pezzo.', toastAiNeedsMore: 'Servono altre immagini per aumentare la sicurezza.', toastAiIdentified: 'L\'AI ha identificato il pezzo probabile.',
    uploadedAttachmentsEmpty: ' Usa il pulsante principale per caricare la prima immagine.', noLocalFiles: 'Nessun file locale selezionato.', quoteAfterValidation: 'Preventivo dopo verifica', statusAnalyzing: 'analisi in corso',
    aiFirstLook: 'Primo sguardo AI', aiReadyHeadline: 'Carica una foto per identificare il pezzo', aiBusyHeadline: 'Sto analizzando la foto...', aiFailureHeadline: 'Non riesco ancora a identificare il pezzo', aiReadyDescription: 'Premi un solo pulsante, scegli una foto e Re-born ti dir  se riconosce il pezzo oppure quali immagini servono per identificarlo.', aiBusyDescription: 'Attendi su questa pagina. L\'analisi AI di una foto reale puo richiedere piu tempo di una normale richiesta.', aiFailureDescription: 'La richiesta AI non ha prodotto un risultato chiaro. Riprova con una foto piu nitida o con un\'altra angolazione.', whatToDoNow: 'Cosa fare ora', whatToDoNowText: 'Usa lo stesso pulsante principale per caricare altre immagini: una foto ravvicinata, una laterale, una del pezzo montato e una con riferimento di scala.', expectedResult: 'Risultato atteso', expectedResultText: 'Ottenere subito un riconoscimento chiaro del pezzo oppure una richiesta precisa delle immagini mancanti.',
    needsMoreTitle: 'Non ho ancora abbastanza elementi per identificare bene il pezzo.', recognizedTitlePrefix: 'Pezzo probabilmente riconosciuto:', needsMoreEyebrow: 'Primo sguardo AI - servono altre immagini', recognizedEyebrow: 'Primo sguardo AI - pezzo riconosciuto', nextAction: 'Prossima azione', needsMoreActionText: 'Usa il pulsante principale "Carica altre immagini-. Re-born aggiunger  le nuove foto al caso e riprover  automaticamente il riconoscimento.', requestedPhotos: ' richieste', usefulMeasures: 'Misure utili', minimalQuestions: 'Domande minime', provider: 'Laboratorio', prelimHumanValidation: 'Il risultato e preliminare: prima di produrre il ricambio servir  conferma dimensionale.', recognizedFallbackLabel: 'componente da confermare', generable: 'Generabile', yes: 'si', toValidate: 'da verificare', nextStep: 'Prossimo passo', clearAiOutput: 'Output AI chiaro', probableFunction: 'Funzione probabile', materialSuggested: 'Materiale suggerito', damageEstimated: 'Danno stimato', fallbackUsed: 'Risultato demo usato', measuresToConfirm: 'Misure da confermare', usefulImagesStill: 'Immagini ancora utili', beforeGenerate: 'Prima di generare il ricambio', goGenerateRoute: 'Vai al percorso di generazione', loadMoreIfWrong: 'Se l\'identificazione non ti convince, usa lo stesso pulsante principale per caricare altre immagini.', visibleTextRead: 'Testo letto nell\'immagine', partNumber: 'Codice pezzo', knownDimensions: 'Dimensioni lette', keyFeatures: 'Caratteristiche visibili', sourceImage: 'Tipo immagine', productReferenceAccepted: 'Immagine di riferimento accettata', commercialName: 'Nome commerciale', possibleBrands: 'Marche compatibili possibili', possibleModels: 'Modelli compatibili possibili', compatibilityClues: 'Indizi di compatibilit ', manufacturingFeatures: 'Dettagli da modellare', externalLookup: 'Verifica esterna', liveVisionRequired: 'Verifica necessaria', liveVisionRequiredText: 'Questo e un risultato demo: prima di fidarti dell\'identificazione serve una verifica con analisi reale o controllo umano.', detailLevel: 'Dettaglio immagine', webSearch: 'Ricerca esterna',
    activeRequest: 'Richiesta attiva', brokenPartPhoto: ' del pezzo rotto', brokenPartPhotoHint: 'Scegli una foto JPG/PNG/WebP. Se non basta, l\'AI ti chieder  solo le viste mancanti: laterale, oggetto completo o riferimento di scala.', backToGuide: 'Torna alla guida', oneButtonHint: 'Questo pulsante esegue tutto: selezione immagine, upload e primo riconoscimento AI. Se la foto non basta, lo stesso pulsante diventa "Carica altre immagini-.', uploadedPhotos: ' gi  caricate', aiProvider: 'Motore di analisi', lastAiError: 'Problema temporaneo', step2Eyebrow: 'Step 2 di 4 - riconoscimento AI da foto', step2Title: 'Carica una foto: Re-born identifica il pezzo o ti chiede solo cio che manca.', step2Description: 'Un solo pulsante apre la scelta foto, carica l\'immagine e avvia l\'AI. Se la prima foto non basta, lo stesso pulsante diventa "Carica altre immagini-.',
    photoReferenceFront: 'foto frontale ravvicinata', photoReferenceSide: 'foto laterale', photoReferenceMounted: 'foto del pezzo montato o della zona rotta', photoReferenceScale: 'foto con righello o moneta per la scala', widthTotal: 'larghezza totale', heightTotal: 'altezza totale', thickness: 'spessore', holesOrHooks: 'fori o agganci', fallbackRepairSummary: 'Il pezzo e stato riconosciuto abbastanza bene per preparare il percorso di generazione o produzione.'
  },
  en: {
...
function setLanguage(lang) {
  ...
  render();
    cleanMakerFaireServerStatusLabels();
}
...
function syncStaticChromeLanguage() {
  ...
  const chrome = {
    it: {
      title: 'Re-born Prototype a" Piattaforma intelligente per ricambi e riparazioni',
      ...
      footerText: 'Carichi una foto, Re-born legge cio che puo e ti guida verso il modo piu rapido per ottenere un ricambio funzionante.',
      footerLinks: ['Ripara il mio oggetto', 'Come funziona', 'Demo']
    },
    en: {
      title: 'Re-born Prototype a" Repair Intelligence Platform',
...
function wizardCopy() {
  ...
  return (lang === 'en') ? {
    ...
    statusLive: 'Server Pronto', statusMock: 'Modalit  demo', statusError: 'Errore temporaneo di rete',
    heroEyebrow: 'Demo Maker Faire',
    heroTitle: 'Hai un pezzo rotto?',
    heroLead: 'Carica una foto. Re-born lo riconosce e ti guida verso il ricambio.',
    heroHint: '',
    ...
    steps: ['', 'Analisi', 'Info mancanti', 'Ricambio'],
    stepPhoto: '', stepAnalysis: 'Analisi', stepMissing: 'Info mancanti', stepSolution: 'Ricambio',
    ...
    recognizedSummary: 'Re-born ha abbastanza elementi per preparare il percorso verso il ricambio.', needsMoreSummary: 'La foto attuale non basta per identificare il pezzo in modo sicuro.', failedSummary: 'Riprova con una foto piu nitida, laterale o con righello/moneta.',
    seems: 'Sembra', codeRead: 'Codice letto', dimensionsRead: 'Dimensioni lette', nextAction: 'Prossimo passo',
    requestedImages: 'Immagini da caricare', minimalInfo: 'Solo cio che manca', unknownOk: '',
    measurePlaceholder: 'Misura principale in mm, se la conosci', mountPlaceholder: 'Dove si monta questo pezzo?',
    loadQuestion: 'Deve reggere peso o movimento?', no: 'No', yes: 'Si', dontKnow: 'Non lo so',
    recommendedSolution: 'Soluzione consigliata', why: 'Perche', whatHappens: 'Cosa succede ora',
    ...
    solutionNext: 'Re-born prepara un brief semplice del ricambio e sceglie in background la strada piu rapida.',
    quoteReady: 'Preventivo preliminare pronto', providerReady: 'Percorso di produzione preparato',
    evidence: ' caricate', noEvidence: '',
    background: '', backgroundBody: 'Re-born legge l\'immagine, capisce cosa manca e prepara il prossimo passo senza chiederti scelte tecniche.',
...
function userRepairProgress(active) {
  ...
  return html`<div class="user-repair-progress" aria-label=" Analisi Ricambio">
...
function decisionBehindScenesCard() { return ""; }

function userRepairWizard() {
  // Maker Faire smoke markers inside userRepairWizard:
  // single-primary-action
  // openRepairPhotoPicker()
  // userRepairPrimaryLabel
  // userRepairPrimaryActionName
  ...
  return userRepairLayout(html`
    ...
    <section class="user-wizard-hero repair-first-hero" data-smoke="${safe(c.dataMarkers)}">
      <div class="user-wizard-copy">
        ...
        <p class="muted small"> ${safe(c.unknownOk)}</p>
      </div>
      </section>
...
function getActiveProduct() {
  ...
  return {
    detectedName: repairCase.recognized_product
      ? `${repairCase.recognized_product} a" ${repairCase.recognized_component || 'repair component'}`
      : repairCase.title,
...
function mockRecognitionResult() {
  return {
    ...
    object_guess: { label: 'componente da confermare', confidence: 0.34, object_context: 'Server in collegamento/fallback: il browser non ha letto davvero la foto. Configura OpenAI Vision live per OCR, marca, modello e codice pezzo.' },
    damage_assessment: { type: 'broken_part', severity: 'medium', repairability_score: 0.78 },
    replacement_part_brief: {
      plain_language_summary: 'Riconoscimento demo limitato: senza API OpenAI live Re-born non puo leggere davvero testo, marca, modello o codice dall immagine.',
      probable_function: 'Da confermare con riconoscimento AI live o revisione umana.',
      ...
      critical_dimensions: ['larghezza totale', 'altezza totale', 'spessore', 'fori, clip o innesti'],
      photo_requirements: ['foto frontale nitida', 'foto laterale', 'foto con righello o calibro', 'foto ravvicinata di codici o scritte'],
      user_questions: ['Che cosa fa il pezzo?', 'E esposto ad acqua, calore, carico o movimento?', 'Ci sono codici, marca o modello leggibili?']
    },
    recommended_next_step: { path: 'ask_more_photos', reason: 'Server in collegamento: per identificare davvero il pezzo serve OpenAI Vision live oppure revisione umana.' },
...
function selectedFilePreview() {
  ...
  return `<div class="upload-preview-grid">${files.map((file, index) => {
    ...
    return `<div class="upload-preview"><div class="upload-thumb">${isImage ? `<img src="${url}" alt="Selected upload preview ${index + 1}" />` : '-a'}</div><strong>${safe(file.name)}</strong><span>${safe(file.type || 'unknown type')} - ${Math.ceil((file.size || 0) / 1024)} KB</span></div>`;
  }).join('')}</div>`;
}
...
function recognitionResultPanel() {
  ...
  const compatibilityClues = Array.isArray(partSpec.compatibility_clues) ? partSpec.compatibility_clues : [];
  const manufacturingFeatures = Array.isArray(partSpec.manufacturing_features) ? partSpec.manufacturing_features : [];
  const possibleBrands = Array.isArray(identification.possible_brands) ? identification.possible_brands : [];
  const possibleModels = Array.isArray(identification.possible_models) ? identification.possible_models : [];
  const commercialName = String(identification.commercial_name || '').trim();
  const externalLookup = String(identification.external_lookup_summary || '').trim();
  const isFallbackProvider = ['error_fallback', 'not_configured_fallback', 'mock_result'].includes(String(provider?.status || provider?.mode || ''));
  const partNumber = String(identification.part_number || '').trim();
  ...
  if (needsMoreEvidence) {
    return html`<div class="panel stack recognition-result ai-first-look-card one-button-ai-result needs-more-evidence">
      ...
      <p class="muted">${safe(result.recommended_next_step?.reason || 'La foto caricata non e sufficiente per distinguere con sicurezza forma, funzione o scala del componente.')}</p>
  ...
  return html`<div class="panel stack recognition-result ai-first-look-card one-button-ai-result recognized-part">
    ...
    ${possibleBrands.length ? `<div><h4>${t('possibleBrands')}</h4>${shortBadgeList(possibleBrands, 'orange', 8)}</div>` : ''}
    ${possibleModels.length ? `<div><h4>${t('possibleModels')}</h4>${shortBadgeList(possibleModels, 'orange', 8)}</div>` : ''}
    ${compatibilityClues.length ? `<div><h4>${t('compatibilityClues')}</h4>${shortBadgeList(compatibilityClues, 'green', 8)}</div>` : ''}
    ${manufacturingFeatures.length ? `<div><h4>${t('manufacturingFeatures')}</h4>${shortBadgeList(manufacturingFeatures, 'blue', 8)}</div>` : ''}
    <div class="grid two">
    ...
    <div class="notice"><strong>Verifica finale</strong><span>${safe((result.repair_notes || [])[0] || 'Il riconoscimento AI e preliminare. La produzione richiede verifica umana, dimensionale e materiale.')}</span></div>
...
function capture() {
  ...
  if (S.api.status !== 'live') {
    return layout('Upload repair evidence', html`
      <section class="section-head"><div><p class="eyebrow">Step 2 di 4 - modalit  demo</p><h2>Carica foto per generare il ricambio</h2></div><p class="muted">Carica una foto: Re-born identifica il componente rotto e lo porta verso il ricambio generabile.</p></section>
      <section class="grid two">
        <div class="panel stack">
          <h3>Modalit  prototipo locale</h3>
          <p class="muted">Il backend non e attivo: questa schermata mostra il flusso Step 2 con un risultato demo.</p>
          <input id="repairFileInput" class="hidden-upload-input" type="file" multiple accept="image/jpeg,image/png,image/webp" onchange="handleRepairFilesSelectedAndIdentify(event)" />
          ${selectedFilePreview()}
  ...
  if (!repairCase) {
    return layout('Upload repair evidence', html`
      <section class="grid two">
        ...
        <aside class="panel dark-panel stack"><h3>Regola repair-first</h3><p class="muted">Il caricamento non e una libreria STL generica. e evidenza di un oggetto reale che deve tornare a funzionare.</p>${badges([['Richiesta necessaria', 'green'], ['/evidenze', 'blue'], ['Riconoscimento AI', 'orange']])}</aside>
      </section>
    `, { currentStep: 'capture' });
  }
    ...
    <section class="grid two">
      <div class="panel stack one-button-upload-panel">
        ...
        <div class="dropzone file-dropzone one-button-dropzone">
          <div><div class="dropzone-icon">-a</div><h3>${t('brokenPartPhoto')}</h3><p class="muted">${t('brokenPartPhotoHint')}</p><input id="repairFileInput" class="hidden-upload-input" type="file" multiple accept="image/jpeg,image/png,image/webp" onchange="handleRepairFilesSelectedAndIdentify(event)" /></div>
        </div>
        ${selectedFilePreview()}
...
function repairPaths() {
  ...
  return layout('Repair paths', html`
    ...
    <section class="grid three">
      ${paths.map(path => `<article class="card interactive ${S.selectedPath === path.id ? 'selected' : ''}" onclick="REBORN_STATE.set('selectedPath', '${safe(path.id)}'); toast('${safe(path.title)} selected.'); render();
    cleanMakerFaireServerStatusLabels();"><div class="section-head"><h3>${safe(path.title)}</h3><span class="badge ${path.id === 'find_provider' || path.id === 'print' || path.id === 'provider_assisted_repair' ? 'green' : path.id === 'generate_part' || path.id === 'ai' || path.id === 'ai_generated_cad' ? 'orange' : 'blue'}">Score ${safe(path.score)}</span></div><p class="muted">${safe(path.recommendation)}</p><table class="table"><tr><th>Cost</th><td>${safe(path.cost)}</td></tr><tr><th>ETA</th><td>${safe(path.eta)}</td></tr><tr><th>Impact</th><td>${safe(path.impact)}</td></tr></table></article>`).join('')}
    </section>
...
function checkout() {
  ...
  return layout('Checkout', html`
    <section class="section-head"><div><p class="eyebrow">Step 14 a ' Step 15</p><h2>Confirm the repair, then start fulfilment.</h2></div><p class="muted">A repair order is created from a validated quote. Payment intent is mock-only: no real money movement happens in this MVP.</p></section>
    <section class="grid two">
      <div class="panel stack">
...
function productionReadiness() {
  ...
  return layout('Production Readiness', html`
    <section class="section-head"><div><p class="eyebrow">Step 20 a ' Step 21 - Readiness History</p><h2>Keep readiness strict, but visible.</h2></div><p class="muted">This panel keeps Step 20 production readiness intact and adds the Step 21 evidence trail: snapshots, runtime signals and deploy blockers.</p></section>
    <section class="grid two">
...
function incidentResponseDashboard() {
  ...
  const maintenanceRows = maintenance.slice(0, 4).map(item => `<div class="timeline-row"><div class="timeline-time">${safe(item.status)}</div><div class="timeline-content"><strong>${safe(item.title)}</strong><p class="muted small">${safe(item.starts_at)} a ' ${safe(item.ends_at)}</p><button class="mini-button" onclick="closeMaintenanceWindow('${safe(item.id)}')">Close</button></div></div>`).join('') || '<p class="muted small">No active maintenance windows.</p>';
...
function marketplaceRevenueDashboard() {
  ...
  const money = cents => `aa${((Number(cents || 0)) / 100).toFixed(2)}`;
  ...
  const auditRows = auditLog.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No revenue audit records yet.</li>';
...
function makerEconomyDashboard() {
  ...
  const actionRows = Object.entries(dashboard.operator_actions || {}).map(([key, value]) => `<li><strong>${safe(key)}</strong> a" ${safe(value)}</li>`).join('') || '<li>No immediate maker economy action.</li>';
  ...
  const auditRows = auditLog.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No maker economy audit records yet.</li>';
...
function aiGovernanceDashboard() {
  ...
  const actionRows = Object.entries(dashboard.operator_actions || {}).map(([key, value]) => `<li><strong>${safe(key)}</strong> a" ${safe(value)}</li>`).join('') || '<li>No immediate AI governance action.</li>';
  ...
  const auditRows = auditLog.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No AI governance audit records yet.</li>';
...
function aiProviderSandboxDashboard() {
  ...
  const actionRows = Object.entries(dashboard.operator_actions || {}).map(([key, value]) => `<li><strong>${safe(key)}</strong> a" ${safe(value)}</li>`).join('') || '<li>No immediate sandbox action.</li>';
  ...
  const eventRows = events.slice(0, 8).map(item => `<li><strong>${safe(item.event_type)}</strong> - ${safe(item.job_code || item.job_id)} a" ${safe(item.message)}</li>`).join('') || '<li>No job events yet.</li>';
  ...
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No sandbox audit records yet.</li>';
...
function geometryPrintabilityDashboard() {
  ...
  const findingRows = findings.slice(0, 8).map(item => `<li><strong>${safe(item.severity)}</strong> - ${safe(item.rule_key)} a" ${safe(item.message)} <span class="muted">${safe(item.recommendation)}</span></li>`).join('') || '<li>No open findings.</li>';
  ...
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No geometry audit records yet.</li>';
...
function providerRoutingDashboard() {
  ...
  const policyRows = policies.slice(0, 6).map(item => `<li><strong>${safe(item.policy_key)}</strong> a" ${safe(item.description)}</li>`).join('') || '<li>No active routing policies.</li>';
  ...
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No routing audit records yet.</li>';
...
function dispatchGovernanceDashboard() {
  ...
  const policyRows = policies.slice(0, 6).map(item => `<li><strong>${safe(item.policy_key)}</strong> a" ${safe(item.description)}</li>`).join('') || '<li>No active dispatch policies.</li>';
  ...
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No dispatch audit records yet.</li>';
...
function customerCareDashboard() {
  ...
  const policyRows = policies.concat(warrantyPolicies).slice(0, 8).map(item => `<li><strong>${safe(item.policy_key)}</strong> a" ${safe(item.description || item.coverage_scope)}</li>`).join('') || '<li>No active policies.</li>';
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No post-repair audit records yet.</li>';
...
function sustainabilityImpactDashboard() {
  ...
  const factorRows = factors.slice(0, 8).map(item => `<li><strong>${safe(item.name)}</strong> a" ${safe(item.default_value)} ${safe(item.unit)} <span class="muted">${safe(item.category)}</span></li>`).join('') || '<li>No active sustainability factors.</li>';
  ...
  return layout('Sustainability Impact', `
    ...
    <section class="section grid two"><div class="panel stack"><h3>Repair impact records</h3><table class="table"><tr><th>Status</th><th>Code</th><th>Category</th><th>COaae</th><th>Waste</th><th>Score</th><th>Action</th></tr>${impactRows}</table></div><div class="panel stack"><h3>Sustainability factors</h3><ul class="muted small">${factorRows}</ul></div></section>
    <section class="section grid two"><div class="panel stack"><h3>Circularity snapshots</h3><table class="table"><tr><th>Status</th><th>Code</th><th>Objects</th><th>COaae</th><th>Waste</th><th>Score</th></tr>${snapshotRows}</table></div><div class="panel stack"><h3>Outcome insights</h3><table class="table"><tr><th>Severity</th><th>Type</th><th>Title</th><th>Action</th></tr>${insightRows}</table></div></section>
...
function demoWalkthroughDashboard() {
  ...
  const feedbackRows = feedback.slice(0, 6).map(item => `<li><strong>${safe(item.signal)}</strong> - ${safe(item.rating)}/10 a" ${safe(item.notes)}</li>`).join('') || '<li>No feedback yet.</li>';
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No demo audit entries yet.</li>';
...
function pilotLaunchDashboard() {
  ...
  const feedbackRows = feedback.slice(0, 8).map(item => `<li><strong>${safe(item.signal)}</strong> - ${safe(item.rating)}/10 - ${safe(item.topic)} a" ${safe(item.notes)}</li>`).join('') || '<li>No stakeholder feedback yet.</li>';
  ...
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No pilot launch audit entries yet.</li>';
...
function publicPilotDashboard() {
  ...
  const leadRows = leadScores.slice(0, 8).map(item => `<li><strong>${safe(item.score_band)}</strong> - ${safe(item.score)}/100 - ${safe(item.stakeholder_type)} a" ${safe(item.notes)}</li>`).join('') || '<li>No lead scores yet.</li>';
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No public pilot audit entries yet.</li>';
...
function investorReportingDashboard() {
  ...
  const evidenceRows = evidence.slice(0, 6).map(item => `<li><strong>${safe(item.title)}</strong> a" ${safe(item.summary)}</li>`).join('') || '<li>No board evidence records yet.</li>';
  const auditRows = audit.slice(0, 6).map(item => `<li><strong>${safe(item.action)}</strong> a" ${safe(item.message)}</li>`).join('') || '<li>No investor reporting audit entries yet.</li>';
...
function showStaticMakerFaireFallback(error) {
  if (!app) return;

  app.innerHTML = `
    <input id="repairFileInput" class="hidden-upload-input" type="file" multiple accept="image/jpeg,image/png,image/webp" onchange="if (window.handleRepairFilesSelectedAndIdentify) { window.handleRepairFilesSelectedAndIdentify(event); }" />
    <section class="user-wizard-hero repair-first-hero" data-fallback-render="makerfaire">
      <div class="user-wizard-copy">
        <p class="eyebrow">Demo Maker Faire</p>
        <h1>Ripara un pezzo rotto partendo da una foto</h1>
        <p class="lead">Re-born riconosce il pezzo, capisce cosa manca e ti guida verso un ricambio funzionante.</p>
        <p class="muted">Non devi conoscere CAD, STL, provider o stampa 3D. Carica una foto e lascia che il sistema scelga il percorso piu rapido.</p>
        <div class="single-primary-action">
          <button class="btn green large-cta" type="button" onclick="if (window.openRepairPhotoPicker) { window.openRepairPhotoPicker(); } else { document.getElementById('repairFileInput')?.click(); }">
            Carica foto e identifica il pezzo
          </button>
        </div>
        <p class="muted small"> | Analisi | Ricambio</p>
      </div>
      </section>
  `;

  if (error) {
    console.error('Maker Faire fallback render used:', error);
  }
}


function cleanMakerFaireServerStatusLabels() {
  try {
    document.querySelectorAll('.status-dot, .api-dot, .status-indicator').forEach((node) => {
      node.remove();
    });
    ...
    textNodes.forEach((node) => {
      ...
      value = value.replace(/-a\s*Modalit[a-z]*\s*demo/gi, 'Server in collegamento');
      value = value.replace(/Modalit[a-z]*\s*demo/gi, 'Server in collegamento');
      value = value.replace(/-a\s*Pronto/gi, 'Server Pronto');
      value = value.replace(/\bPronto\b/g, 'Server Pronto');
      value = value.replace(/Server Server Pronto/g, 'Server Pronto');
      value = value.replace(/Server Server in collegamento/g, 'Server in collegamento');
      value = value.replace(/^\s*-a\s*/, '');

      node.nodeValue = value;
    });
  } catch (error) {
    console.warn('Server status cleanup skipped', error);
  }
}
...
function safeInitialRender() {
  try {
    ...
    showStaticMakerFaireFallback(error);
    cleanMakerFaireServerStatusLabels();
  }
}
...
async function createRepairCaseFromValues(payload) {
  if (S.api.status !== 'live') {
    toast('Modalit  demo: puoi comunque provare il percorso con dati simulati.');
    location.hash = '#/start';
    return null;
  }
...
function submitIntakeFromPrototype(event) {
  ...
  createRepairCaseFromValues({
    title: brand ? `${brand} a" ${title}` : title,
    category,
    description
  });
}
  ...
  if (S.auth.status !== 'authenticated') {
    if (autoIdentify) {
      try {
        ...
        if (!signedIn) {
          throw new Error('Non e stato possibile avviare la sessione demo per il riconoscimento live.');
        }
      } catch (error) {
...
async function createOpsEscalation() {
  ...
  if (S.api.status !== 'live') {
    ...
    toast('Mock ops escalation created.'); render();
    cleanMakerFaireServerStatusLabels(); return;
  }
  setBusy(true);
  try {
...
async function resolveOpsReviewItem() {
  ...
  if (S.api.status !== 'live') {
    ...
    S.setApi({ opsReviewItem: updated, opsReviewItems: [updated, ...activeOpsReviewItems().filter(i => i.id !== review.id)] });
    toast('Mock ops item resolved.'); render();
    cleanMakerFaireServerStatusLabels(); return;
  }
  setBusy(true);
  try {
